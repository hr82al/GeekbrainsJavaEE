...
public class ProductRepository {
    ...
    public ProductRepository() {
        this.add(new Product("1", "Pen", 50, "канцтовары"));
        this.add(new Product("2", "Pencil", 150, "канцтовары"));
        this.add(new Product("3", "Textbook", 200, "канцтовары"));
        this.add(new Product("4", "Paper", 500, "канцтовары"));
    }
